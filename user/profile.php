...
$profile = mysqli_query($con, "SELECT * FROM user WHERE id='$user_id'") or die("Error occurde in profile query" . mysqli_error($con));
                    ...
                    <div class="widget-content nopadding" style="border-radius: 15px; margin: right 10px">
                        <form action="#" method="Post" class="form-horizontal">
                            ...
                            <div class="control-group" id="profile">
                                ...
                                <strong class="control-label"><?php echo $row['subcity']; ?>
                                </strong>
                            </div>
                            <hr>
                            <div class="control-group" id="profile">
