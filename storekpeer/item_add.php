                        ...
                        <form name="formsend" action="#" method="POST" class="form-horizontal" onsubmit='return formValidation()'>
                            ...
                            ?>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="number" class="span11" placeholder="Enter item code" name="code" required min="1" style="border-radius: 13px;" />
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="nationality" class="span11" placeholder="Enter item model" name="model" required style="border-radius: 13px;" />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label"><strong>Item Quality:</strong></label>
                                    <div class="controls">
                                        <input type="text" id="subcity" class="span11" placeholder="Enter item quality" name="quality" required style="border-radius: 13px;" />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label"><strong>Item Quantity :</strong></label>
                                    <div class="controls">
                                        <input type="number" class="span11" placeholder="Enter item quantity" name="quantity" required min="1" style="border-radius: 13px;" />
                                    </div>
                                </div>
                                <div class="control-group">
